...
def read_command():
    c = stdscr.getch()
    arrow_codes = {curses.KEY_LEFT: COMMAND_LEFT,
    ...
    other_codes = {exit_codes: COMMAND_EXIT, 
...
def send_command(socket, command, screen):
    messages = {COMMAND_LEFT: 'LEFT', 
                COMMAND_RIGHT: 'RIGHT', 
                COMMAND_UP: 'UP', 
                COMMAND_DOWN: 'DOWN',
                COMMAND_RESTART: 'RESTART...',
                COMMAND_EXIT: 'EXIT...'}
    commands = {COMMAND_LEFT: 0, 
                COMMAND_RIGHT: 1, 
                COMMAND_UP: 2, 
                COMMAND_DOWN: 3,
                COMMAND_RESTART: 4,
    ...
    sock.send(str(commands[command]))
