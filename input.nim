...
proc initInputProcessor*(host: string = "localhost", port: Port = Port(12321)): InputProcessor = 
    var s = newSocket()
...
method read*(self: var InputProcessor): Commands =
    if nil == self.client:
